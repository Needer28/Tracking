...
def _main():
    ...
    annotation_path = rootpath + trainvaltype+'train.txt'
    data_path = rootpath + trainvaltype+'train.npz'
    output_path = 'model_data/qi_yolo.h5'
    log_dir = 'logs/000/'
    classes_path = 'model_data/qi_voc_classes.txt'
