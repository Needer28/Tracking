...
class YOLO(object):
    def __init__(self):
        ...
        self.model_path = 'motusemodel/yolo.h5'
...
if __name__ == '__main__':
    ...
    if train:
        ...
        foldername = ('dark', 'havingcar', 'moving')
        length = (849, 900, 1574)
    ...
    for folder, l in zip(foldername, length):
        ...
        for im_name in im_names:
            ...
            if train:
                ...
                path = '/home/qi/benchmark/MOTQi/%s/img1' % folder
        ...
        with open('/home/qi/benchmark/MOTQi/%s/det/det.txt' % folder, 'w') as rst_f:
