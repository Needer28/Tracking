...
class YOLO(object):
    def __init__(self):
        self.model_path = 'model_data/qi_yolo.h5'
        self.anchors_path = 'model_data/yolo_anchors.txt'
        # self.classes_path = 'model_data/coco_classes.txt'
        self.classes_path = 'model_data/qi_voc_classes.txt'
        ...
        self.model_image_size = (416, 416) # fixed size or (None, None) any value multiple of 32
...
if __name__ == '__main__':    
    ...
    for folder, l in zip(foldername, length):
        ...
        with open('/home/qi/keras-yolo3_v1/MOT17Det_newresults/yolov3/train/%s/det.txt' % folder, 'w') as rst_f:
