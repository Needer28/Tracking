...
%
% draw dres structure
function Qi_show_dres(frame_id, I, tit, dres, state, cmap)
...
% axis normal;
% text(size(I,1), size(I,2), num2str(frame_id), 'BackgroundColor', [.7 .9 .7], 'FontSize', 14);

text(30, 30, num2str(frame_id), 'BackgroundColor', 'white', 'FontSize', 14)
