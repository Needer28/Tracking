...
%     filename = sprintf('results_MOT/%s_tracker.mat', mot2d_train_seqs{idx_train{end}});
    filename = sprintf('/home/qi/projects/MDP_Tracking-master/results/%s_tracker.mat', mot2d_train_seqs{idx_train{end}});
...
%     filename = sprintf('results_MOT/%s_tracker_det.mat', mot2d_train_seqs{idx_train{end}});
    filename = sprintf('/home/qi/projects/MDP_Tracking-master/results/%s_tracker_det.mat', mot2d_train_seqs{idx_train{end}});
    object = load(filename);
    tracker = object.tracker;
    fprintf('load tracker from file %s\n', filename);
